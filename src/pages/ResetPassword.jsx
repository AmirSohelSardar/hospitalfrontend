...
const ResetPassword = () => {
  ...
  const submitHandler = async event => {
    ...
    // FIX: added password match validation that was missing
        ...
        <form className="py-4 md:py-0" onSubmit={submitHandler}>
          ...
          <div className="mb-5">
            <input
              ...
              required
            />
            {/* FIX: show mismatch warning inline */}
            {formData.confirmPassword && formData.newPassword !== formData.confirmPassword && (
              <p className="text-red-500 text-[14px] mt-1">Passwords do not match</p>
            )}
          </div>
          ...
          <div className="mt-7">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3 disabled:opacity-70"
            >
