  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 mx-auto">
        ...
        {/* FIX: guard against rendering before data is loaded (doctor was []) */}
        {!loading && !error && doctor && !Array.isArray(doctor) && (
          <div className="grid md:grid-cols-3 gap-[50px]">
            <div className="md:col-span-2">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-[6px]">
                    <span className="flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                      ...
                      {doctor.averageRating !== undefined ? doctor.averageRating.toFixed(2) : '0.00'}
                    </span>
              ...
              <div className="mt-[50px]">
                ...
                {tab === 'feedback' && (
                  <Feedback reviews={doctor.reviews} totalRating={doctor.totalRating} />
                )}
