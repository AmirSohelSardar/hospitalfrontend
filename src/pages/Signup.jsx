...
const Signup = () => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    try {
      ...
      // FIX: original silently failed — photo stayed null causing backend 500
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5">
                ...
                />
                {nameError && (
                  <p className="text-red-500 text-[14px] font-medium mt-1">{nameError}</p>
                )}
              </div>
              ...
              <div className="mb-5">
                ...
                />
                {emailError && (
                  <p className="text-red-500 text-[14px] font-medium mt-1">{emailError}</p>
                )}
              </div>
              ...
              <div className="mb-5">
                ...
                />
                {passwordError && (
                  <p className="text-red-500 text-[14px] font-medium mt-1">{passwordError}</p>
                )}
              </div>
