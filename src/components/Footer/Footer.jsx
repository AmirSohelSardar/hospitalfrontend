...
const socialLinks = [
  {
    path: "https://www.youtube.com/@DSA_MERN",
    icon: <AiFillYoutube className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://github.com/AmirSohelSardar",
    icon: <AiFillGithub className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.instagram.com/amirsohelsardar786/",
    icon: <AiOutlineInstagram className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.linkedin.com/in/amir-sohel-sardar-735698243/",
...
/>
            <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">
              Copyright © {year} developed by Amir Sohel all right reserved.
            </p>
